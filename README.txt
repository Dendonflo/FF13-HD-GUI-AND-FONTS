...
--------------------------------------------------------------------------------
!! IMPORTANT -- READ BEFORE UPGRADING FROM AN OLDER VERSION !!
--------------------------------------------------------------------------------

  IF YOU ARE UPGRADING FROM A PREVIOUS 2.X VERSION OF THIS MOD, YOU MUST FIRST
  FULLY UNINSTALL THE OLD VERSION BEFORE INSTALLING THIS ONE.

  THE PREVIOUS RELEASE SHIPPED AS d3d9.dll AND REPLACED FF13FIX ENTIRELY.
